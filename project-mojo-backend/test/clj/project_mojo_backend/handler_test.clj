(ns project-mojo-backend.handler-test
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [project-mojo-backend.handler :refer :all]
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'project-mojo-backend.config/env
                 #'project-mojo-backend.handler/app-routes)
    (f)))
